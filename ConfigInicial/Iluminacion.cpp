...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // =========================================================================================
        // Definimos las propiedades de la luz (Creado durante el video)
        ...
        glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 1.0f); // Para la parte del brillo
