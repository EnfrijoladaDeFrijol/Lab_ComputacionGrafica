/*
	...
	FECHA DE ENTREGA: 11 / OCTUBRE / 2024
*/
...
glm::vec3 pointLightPositions[] = {
	...
	glm::vec3(-1.5f,0.9f, 0.9f),
	glm::vec3(1.4f,1.7f,  -1.5f),
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Fuentes de luz | Luis Arturo Meza Sánchez", nullptr, nullptr);
